...
#import "ConflictViewViewController.h"
#import "ConflictEntry.h"
#import "PTKDocument.h"
#import "PTKMetadata.h"
#import "NSDate+FormattedStrings.h"

@interface ConflictViewViewController ()

@end

@implementation ConflictViewViewController {
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    for (NSFileVersion * fileVersion in fileVersions) {
        ...
        ConflictEntry * entry = [[ConflictEntry alloc] initWithFileVersion:fileVersion metadata:nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ConflictEntry * entry = [_entries objectAtIndex:indexPath.row];
